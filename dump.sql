...
--
-- Host: localhost    Database: eventhub_db
-- ------------------------------------------------------
...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '8542efb8-e8d2-11f0-89da-89a18bd68f49:1-38';
...
CREATE TABLE `users` (
  ...
  `role` enum('organiser','attendee','admin') DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2026-05-07 18:20:16
